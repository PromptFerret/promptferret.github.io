...
const CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRYZVOCBk-RrwBWOWy0d8EB4Ka24Ykh2Y5sCk9cq_b_12hyWGkPn5ugcvk5tMNcFnsOjtB9gDJq3Dv4/pub?gid=2020437039&single=true&output=csv";
...
async function loadData() {
    ...
    try {
        ...
        const mappingObj = await fetchJSON("./custom_mapping.json");
        ...
        const customItemsArr = await fetchJSON("./custom_items.json");
        item_data = {};
...
async function setupMappingConfig() {
    const mappingConfig = await fetchJSON("./custom_mapping.json");
